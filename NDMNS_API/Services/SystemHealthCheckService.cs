...
namespace NDMNS_API.Services
{
    public class SystemHealthCheckService
    {
        ...
        public async Task<SystemHealthResult> GetSystemHealthStatusAsync()
        {
            ...
            _logger.LogInformation(
                "System Health Check - Database: {DatabaseStatus}, Internet: {InternetStatus}, NodeJS: {NodeJsStatus}",
